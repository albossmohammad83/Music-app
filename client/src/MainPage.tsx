...
import pic from '../src/img/homepage_bg.jpg'
  ...
  return (
    ...
    >
      <div className="mw6 lh-copy mb4">
        <Music32 />
        <div className="f3 fw7 mb2"style={{color: 'white' }}>Welcome to Quad-Squad Music App.</div>
        <div className="f4 mb3"
         style={{color: 'white' }}
        >
          Select an instrument and a visualizer on the left to serve some fresh beats.
        </div>
        <div className="f5"style={{color: 'white' }}>The UI is yours to design. Express yourself.</div>
      </div>
    </div>
  );
}
